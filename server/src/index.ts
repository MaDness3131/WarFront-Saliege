...
// Mode Amis — lobby de pré-partie + game room privée matchée par code.
// Les joueurs se rejoignent dans la lobby via joinByCode("AZBK9X"), le host
// configure puis lance, le serveur instancie une GameRoom privée et leur
// envoie son ID via le message 'start'.
gameServer.define('lobby', LobbyRoom).filterBy(['code']);
gameServer.define('friends_game', GameRoom).filterBy(['code']);
